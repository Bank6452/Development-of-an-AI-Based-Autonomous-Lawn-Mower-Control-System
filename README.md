...
ระบบรถตัดหญ้าอัตโนมัติ (Autonomous Lawn Mower) แบบ **Differential Drive** พัฒนาด้วย **ROS 2 Humble** บน **Raspberry Pi 5** ควบคุมฮาร์ดแวร์ผ่าน **STM32F103C8T6** โดยผสาน Sensor หลายตัว (RTK GPS, LiDAR, IMU, Encoder) ด้วยเทคนิค **Extended Kalman Filter (EKF)** เพื่อการ Localization ที่แม่นยำ พร้อมระบบ **Geofencing**, **YOLO Vision**, และ **Nav2 Navigation Stack**

---

## 🎬 Demo

### 🌿 ตัดหญ้าด้วยระบบอัตโนมัติ (Real Field Test)

<div align="center">

![](<Image/FD2922F1-9B54-419D-921C-381F34E6A230.jpg>)
*รถตัดหญ้าอัตโนมัติกำลังปฏิบัติงานในพื้นที่จริง — เห็นแนวการตัดแบบ Zigzag อย่างชัดเจน และเส้นเชือกกำหนดขอบเขต (Geofence) โดยรอบ*

<br>

| รถตัดหญ้าอัตโนมัติขณะทำงานในสนาม | ภาพรวมพื้นที่และแนวการตัด |
|:---:|:---:|
| ![](Image/IMG_6780.JPG) | ![](<Image/LINE_ALBUM_project รถตัหญ้า_260515_1.jpg>) |

| | | |
|:---:|:---:|:---:|
| ![](<Image/LINE_ALBUM_project รถตัหญ้า_260515_2.jpg>) | ![](<Image/LINE_ALBUM_project รถตัหญ้า_260515_3.jpg>) | ![](<Image/LINE_ALBUM_project รถตัหญ้า_260515_4.jpg>) |
| ![](<Image/LINE_ALBUM_project รถตัหญ้า_260515_5.jpg>) | ![](<Image/LINE_ALBUM_project รถตัหญ้า_260515_6.jpg>) | ![](Image/S__77217800.jpg) |

> 📹 **วิดีโอสาธิตการตัดหญ้าจริง:** [`Image/IMG_6782.MOV`](Image/IMG_6782.MOV)

</div>

### ทดสอบในสนามจริง (Setup & Navigation)
...
**สังกัด:** ภาควิชาวิศวกรรมเมคคาทรอนิกส์ — มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
